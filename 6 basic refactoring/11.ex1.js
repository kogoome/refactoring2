...
// 5. 이제 applyShipping()에 전달되는 다양한 매개변수를 살펴보자. 이중 basePrice는 첫 번째 단계를 수행하는 코드에서 생성된다. 따라서 중간 데이터 구조로 옮기고 매개변수 목록에서 제거한다.
...
function applyShipping(priceData, shippingMethod, discount) {
	...
	const price = priceDatabasePrice - priceData.discount + shippingCost
	return price
}
